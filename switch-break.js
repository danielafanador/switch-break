...
if (jugador01 === jugador02) {console.log("Es un empate!")}
    ...
    else if (jugador01 != "piedra" || "papel" || "tijera") {console.log ("Jugaste un valor inválido");}
    else if (jugador02 != "piedra" || "papel" || "tijera") {console.log ("Jugaste un valor inválido");}
